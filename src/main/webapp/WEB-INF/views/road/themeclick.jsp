            ...
            <div class="col-lg-12" style="margin-left: 1%;">
		                    ...
		                    <div class="col-sm-6 col-xl-4 mb-5 hover-animate" data-marker-id="59c0c8e33b1527bfe2abaf92">
		                        <div class="card h-100 border-0 shadow">
		                            ...
		                            <div class="card-body d-flex align-items-center">
		                                <div class="w-100">
		                                    <div class="d-flex">
		                                        <h6 class="card-title" style="width: 85%;"><a class="text-decoration-none text-dark S_core6" href="detail-rooms.html">${road.roadNm}</a></h6>
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination pagination-template d-flex justify-content-center">
                        <li class="page-item">
                            <a class="page-link" href="${path}/road/theme?page=${pageInfo.prvePage}"> <i class="fa fa-angle-left"></i></a>
                        </li>
                        <!-- 페이지 반복문  -->
                        ...
                        <li class="page-item">
                            <a class="page-link" href="${path}/road/theme?page=${pageInfo.nextPage}"> <i class="fa fa-angle-right"></i></a>
                        </li>
