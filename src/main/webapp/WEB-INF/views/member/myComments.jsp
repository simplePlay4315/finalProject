                    ...
                    <div class="col">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-light mb-0">
                                ...
                                <li class="breadcrumb-item S_core4" aria-current="page">내가 댓글단 글</li>
                            </ol>
                        </nav>
                        <!-- End Breadcrumb -->
                    </div>
                            ...
                            <div class="card flex-grow-1 mb-5">
                                <div class="card-body">
                                    ...
                                    <ul class="nav nav-sm nav-tabs nav-vertical mb-4">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active" href="${path}/member/myComments">
                    ...
                    <div class="d-grid gap-3 gap-lg-5">
                        ...
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h4 class="card-header-title S_core6">내가 댓글단 글</h4>
                            </div>
                            ...
                            <div class="card-body" style="margin-top: -21px;">
                                ...
                                <table class="table table-lg">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                         	<th scope="row">${reply.no}</th>
                                            <td>${reply.writerId}나중에 session에서 아이디 받아온 것으로 넣기</td>
                                            <td>${reply.content}</td>
